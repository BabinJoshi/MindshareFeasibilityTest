-- mindshare_score_test.get_global_account_level_metrics
-- CockroachDB port:
--   mindshare.  → mindshare_test.
--   mindshare_score. → mindshare_score_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_global_account_level_metrics(startdate bigint, enddate bigint)
