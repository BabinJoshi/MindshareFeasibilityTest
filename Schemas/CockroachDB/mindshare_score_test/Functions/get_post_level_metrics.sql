-- mindshare_score_test.get_post_level_metrics
-- CockroachDB port:
--   analytics.  → analytics_test.
--   mindshare.  → mindshare_test.
--   mindshare_score. → mindshare_score_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_post_level_metrics(startdate bigint, enddate bigint, projectname text)
