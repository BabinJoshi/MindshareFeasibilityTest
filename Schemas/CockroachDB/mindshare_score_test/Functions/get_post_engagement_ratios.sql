-- mindshare_score_test.get_post_engagement_ratios
-- CockroachDB port:
--   analytics.  → analytics_test.
--   mindshare.  → mindshare_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_post_engagement_ratios(startdate bigint, enddate bigint, projectname text)
