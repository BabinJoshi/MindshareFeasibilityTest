-- mindshare_score_test.get_post_from_user_id
-- CockroachDB port:
--   mindshare.  → mindshare_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_post_from_user_id(p_user_x_id text[], project_name text DEFAULT NULL::text, table_name text DEFAULT NULL::text)
...
BEGIN
    IF project_name IS NOT NULL THEN
        ...
        FROM mindshare_test.mindshare_project p
        WHERE p.project_name = get_post_from_user_id.project_name
        LIMIT 1;
    END IF;
    ...
    IF table_name IS NULL OR table_name = 'mindshare_post' THEN
        ...
        SELECT
            ...
            CASE
                ...
                ELSE 'Under Review'
            END
        FROM mindshare_test.mindshare_post m
    ...
    ELSIF table_name = 'user_post' THEN
        ...
        SELECT
            ...
            END,
            NULL::text
        FROM mindshare_test.user_post u
    ...
    ELSIF table_name = 'nucleus_post' THEN
        ...
        SELECT
            ...
            END,
            NULL::text
        FROM mindshare_test.nucleus_post n
