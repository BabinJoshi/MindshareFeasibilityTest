-- mindshare_score_test.test_create_engagement_clustering_features_view
-- CockroachDB port:
...
CREATE OR REPLACE PROCEDURE mindshare_score_test.test_create_engagement_clustering_features_view(IN project_keyword text)
 LANGUAGE plpgsql
AS $procedure$
DECLARE
...
BEGIN
    ...
    EXECUTE format(
        'CREATE UNIQUE INDEX IF NOT EXISTS %I ON mindshare_score_test.%I (root_post_id)',
