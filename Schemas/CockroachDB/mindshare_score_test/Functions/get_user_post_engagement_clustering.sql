-- mindshare_score_test.get_user_post_engagement_clustering
-- CockroachDB port:
--   mindshare_score. → mindshare_score_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_user_post_engagement_clustering(p_user_id text DEFAULT NULL::text, start_ts bigint DEFAULT NULL::bigint, end_ts bigint DEFAULT NULL::bigint)
...
BEGIN
    ...
    FROM mindshare_score_test.mv_user_posts_engagement_features f
