-- mindshare_score_test.get_account_and_keyword_unique_reach_ratio
-- CockroachDB port:
--   analytics.  → analytics_test.
--   mindshare.  → mindshare_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_account_and_keyword_unique_reach_ratio(startdate bigint, enddate bigint, projectname text)
