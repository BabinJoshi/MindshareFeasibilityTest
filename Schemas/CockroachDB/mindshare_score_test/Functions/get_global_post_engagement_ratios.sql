-- mindshare_score_test.get_global_post_engagement_ratios
-- CockroachDB port:
--   mindshare.  → mindshare_test.

CREATE OR REPLACE FUNCTION mindshare_score_test.get_global_post_engagement_ratios(startdate bigint, enddate bigint)
