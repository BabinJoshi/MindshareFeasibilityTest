-- analytics_test.get_all_users_analytics
-- CockroachDB port:
...
CREATE OR REPLACE FUNCTION analytics_test.get_all_users_analytics(limit_per_user integer DEFAULT NULL::integer)
...
BEGIN
    IF limit_per_user IS NULL THEN
        ...
        incoming_engagements AS (
            ...
            LEFT JOIN mindshare_test.mindshare_user u ON mp.user_x_id = u.x_id
        ),
        post_reach_agg AS (
            SELECT
                author_id,
        ...
        unique_contributions AS (
            ...
            FROM mindshare_score_test.global_contribution_scores cs
            JOIN valid_posts vp
        ...
        with_users AS (
            ...
            FROM user_stats us
            LEFT JOIN mindshare_test.mindshare_user u ON us.x_id = u.x_id
        )
        SELECT
            wu.x_id::text,
            ...
            wu.user_last_post_date as last_post_date,
