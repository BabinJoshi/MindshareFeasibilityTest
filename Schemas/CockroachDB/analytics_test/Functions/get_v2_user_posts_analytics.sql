-- analytics_test.get_v2_user_posts_analytics
-- CockroachDB port:
--   mindshare.         → mindshare_test.
--   mindshare_score.   → mindshare_score_test.
--   analytics.         → analytics_test.
-- Query uses $1..$4 positional params via EXECUTE ... USING — unchanged.

CREATE OR REPLACE FUNCTION analytics_test.get_v2_user_posts_analytics(user_id text, projectname text, startdate bigint, enddate bigint)
...
LEFT JOIN mindshare_score_test.%I ec
