-- mindshare_test.nucleus_user definition
-- CockroachDB port: schema renamed mindshare → mindshare_test

CREATE TABLE mindshare_test.nucleus_user (
...
CREATE INDEX ix_mindshare_nucleus_user_x_username ON mindshare_test.nucleus_user (x_username);
