-- mindshare_test.post_content_signal definition
-- CockroachDB port:
--   PARTITION BY LIST removed
--   schema renamed mindshare → mindshare_test

CREATE TABLE mindshare_test.post_content_signal (
    ...
    CONSTRAINT post_content_signal_pkey PRIMARY KEY (project_keyword, post_created_at, post_id)
);
